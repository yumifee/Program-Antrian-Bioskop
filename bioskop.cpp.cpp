...
cout << "บ2. Jadwal Film                                   บ" << endl;
cout << "บ3. Harga Tiket                                   บ" <<  endl;
...
system("cls");
    ...
    system("cls");
    cout << "";
    layar();			 //menampilkan data tempat duduk yang tersedia dan sudah terbooking 
    input();		    // menampilkan form input data pemesanan tiket
    void input();
    void exit();
    cout << endl
         << endl;
...
cout << "บ                                                  SEDANG TAYANG                                                      บ" << endl;
cout << "บ                                    Berikut list film yang tayang pada hari ini                                      บ" << endl;
...
cout << endl;
cout << "ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป " << endl;
cout << "บ\t No \t\tJudul Film  \t\t\t\t\t\t Kode Film                            บ" << endl;
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 1 \t\tKKN Desa Penari \t\t\t\t\t    dp                                บ" << endl; 
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 2 \t\tKuntilanak 3 \t\t\t\t\t\t    ka                                บ" << endl ; 
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 3 \t\tDoctor Strange \t\t\t\t\t\t    ds                                บ" << endl ; 
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 4 \t\tMosul \t\t\t\t\t\t\t    ms                                บ" << endl ; 
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 5 \t\tKamu Tidak Sendiri \t\t\t\t\t    ts                                บ" << endl ; 
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 6 \t\tGara Gara Warisan \t\t\t\t\t    gw                                บ" << endl ; 
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 7 \t\tTokyo Ghoul \t\t\t\t\t\t    tg                                บ" << endl ; 
cout << "บ                                                                                                                     บ" <<endl;
cout << "บ\t 8 \t\tAshiap Man \t\t\t\t\t\t    am                                บ" << endl ; 
cout << "ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ " << endl;
cout << endl;
    break;
